...
double SumMap(const typename T::const_iterator& begin, const typename T::const_iterator& end)
{
    // initialize a const_iterator for Map
    typename T::const_iterator i;
    // initialize a double as our result
...
{   
    ...
    res = SumMap< map<string, double> >(myMap);
    // print the result
    ...
    res = SumMap< map<string, double> >(myMap.begin(), myMap.end());
    // print the result
