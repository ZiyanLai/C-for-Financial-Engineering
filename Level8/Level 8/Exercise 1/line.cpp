...
Line::Line() : Shape(), p1(Point(0.0, 0.0)), p2(Point(0.0, 0.0)) {}


// Constructor that takes 2 Point values
Line::Line(const Point& startP, const Point& endP) : Shape(), p1(startP), p2(endP) {}


// Copy Constructor
Line::Line(const Line& anotherLine) : Shape(anotherLine), p1(anotherLine.p1), p2(anotherLine.p2) {}  // copy the base portion 
