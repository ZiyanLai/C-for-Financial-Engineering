...
// here we use the Point constructor that takes 2 value
Circle::Circle() : Shape(), center(Point(0.0, 0.0)), m_radius(0.0) {}


// Constructor that takes value
Circle::Circle(const Point& cent, const double& rad) : Shape(), center(cent), m_radius(rad) {}


// Copy Constructor
Circle::Circle(const Circle& anotherC) : Shape(anotherC), center(anotherC.center), m_radius(anotherC.m_radius) {}  // copy the base portion
