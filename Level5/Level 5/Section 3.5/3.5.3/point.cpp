...
/* Also call Base ToString in Point's ToString */
...
// Default Constructor
Point::Point() // here the Default Constructor of Shape class will be called
...
Point::Point(double x, double y)    // here the Default Constructor of Shape class will be called
                                    // so we don't need to explicitly write it 
{
    m_x = x;
    m_y = y;
...
Point::Point(double value) // here the Default Constructor of Shape class will be called
                           // so we don't need to explicitly write it 
{
    m_x = value;
    m_y = value;
