...
/* Using colon syntax to construct Point class */
/* print messages in Point's Constructor, Descturctor, Assignment Operator */
...
// Default Constructor
Point::Point() : m_x(0), m_y(0){ cout << "Point Default Constructor\n"; } // set the X and Y coordinates to 0 by default

// Copy Constructor
Point::Point(const Point& anotherP) : m_x(anotherP.m_x), m_y(anotherP.m_y){ cout << "Point Copy Constructor\n"; }

// Constructor that takes 2 value
Point::Point(double x, double y) : m_x(x), m_y(y){ cout << "Point Constructor that takes 2 values\n"; }     

// Constructor that takes 1 value
Point::Point(double value) : m_x(value), m_y(value){ cout << "Point Constructor that takes 1 value\n"; }
