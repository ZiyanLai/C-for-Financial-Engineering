...
int main()
{
    ...
    cout << sp -> ToString() << endl;       // What is printed?
                                            // Since we don't have keyword 'virtual' in the ToString function in Shape class,
                                            // when we dereference the pointer, this will only call the Shape's ToString function, rather than
                                            // the Point's own ToString function.
                                            // However, Point's ID is printed. 
